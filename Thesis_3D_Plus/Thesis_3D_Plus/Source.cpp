...
int main(int argc, char **argv)
{
	...
	(((Fl_Input_Choice*)((GLWindow*)glWindow)->ShaderOptions))->add("Light direction");
	(((Fl_Input_Choice*)((GLWindow*)glWindow)->ShaderOptions))->add("Fong model");
	(((Fl_Input_Choice*)((GLWindow*)glWindow)->ShaderOptions))->add("Fong model with use vector half way");
	(((Fl_Input_Choice*)((GLWindow*)glWindow)->ShaderOptions))->add("Fong model directed");
